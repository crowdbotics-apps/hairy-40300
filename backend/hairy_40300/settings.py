"""
Django settings for hairy_40300 project.
...
WSGI_APPLICATION = 'hairy_40300.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hairy_40300 API",
    "DESCRIPTION": "API documentation for hairy_40300 App",
    "VERSION": "v1",
}
